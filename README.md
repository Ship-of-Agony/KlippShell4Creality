![Downloads](https://img.shields.io/github/downloads/Ship-of-Agony/KlippShell4Creality/total?style=flat-square&logo=github&color=blue&cache=bust1)
   ...
   ⚠️ Note: I'm not completely sure yet if this fix by DnG Crafts is actually required for video streams on some devices to ensure full app functionality.⚠️
   ⚠️ See for more Infos: https://github.com/DnG-Crafts/K2-Camera ⚠️
