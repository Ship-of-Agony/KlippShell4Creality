...
🔔 Live Popups & Acoustic Signals
    ...
    Real-Time Telemetry Tracking: The app informs you visually and acoustically about critical printing landmarks:
        ...
        Progress milestones reached at 50%, 75%, and 90%
...
🖼️ Native Picture-in-Picture (PiP) Mode
    ...
    Close the app on your TV to watch your favorite show or browse other applications—a floating, resizable overlay window keeps you updated on the webcam stream and live print progress via a dedicated status label (tvPipProgress).
...
🚀 Advanced Developer Options (Easter Egg)

For power users and developers, clicking the studio logo ("Ship of Agony LABs") inside the About panel 7 times unlocks a hidden advanced menu:

    Manually force an immediate update sync for the Android TV Homescreen channel.

    Layout Override Switch: Manually lock the application into smartphone portrait mode or force tablet/TV landscape layout to test responsive UI behavior across different devices.
